...
*/
        ...
        point1:while(true) {
            ...
            switch (choice)
            {
                ...
                case 1:
                    System.out.printf("Existing courses: %d\n", courses.size());
                    i=1;
                    ...
                    break;
                case 2:
                    System.out.printf("Existing instructors: %d\n", instructors.size());
                    i=1;
                    ...
                    break;
                case 3:
                    System.out.printf("Existing textbooks: %d\n", textbooks.size());
                    i=1;
    ...
    static void userMode() throws IOException, ClassNotFoundException
    {
        Vector<Course> courses = Course.get();
        Vector<Instructor> instructors = Instructor.get();
        Vector<Textbook> textbooks = Textbook.get();
